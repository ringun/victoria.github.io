...
$(document).ready(function(){function e(){var t=f+","+m+" 23:59",n=new Date(t),c=new Date,o=n-c;if(n>c){var a=parseInt(o/864e5);10>a&&(a="0"+a),a=a.toString();var i=parseInt(o/36e5)%24;10>i&&(i="0"+i),i=i.toString();var s=parseInt(o/6e4)%60;10>s&&(s="0"+s),s=s.toString();var l=parseInt(o/1e3)%60;10>l&&(l="0"+l),l=l.toString(),9==a[1]&&2==i[0]&&3==i[1]&&5==s[0]&&9==s[1]&&5==l[0]&&9==l[1]?r($("#day0"),a[0]):$("#day0").html(a[0]),2==i[0]&&3==i[1]&&5==s[0]&&9==s[1]&&5==l[0]&&9==l[1]?r($("#day1"),a[1]):$("#day1").html(a[1]),3==i[1]&&5==s[0]&&9==s[1]&&5==l[0]&&9==l[1]?r($("#hour0"),i[0]):$("#hour0").html(i[0]),5==s[0]&&9==s[1]&&5==l[0]&&9==l[1]?r($("#hour1"),i[1]):$("#hour1").html(i[1]),9==s[1]&&5==l[0]&&9==l[1]?r($("#min0"),s[0]):$("#min0").html(s[0]),5==l[0]&&9==l[1]?r($("#min1"),s[1]):$("#min1").html(s[1]),9==l[1]?r($("#sec0"),l[0]):$("#sec0").html(l[0]),r($("#sec1"),l[1]),setTimeout(e,1e3)}else $(".timer").html("<p id='stop'>Отсчет закончен!!!</p>")}function r(e,r){e.html(r).css({marginTop:"0px"}).animate({marginTop:"0px"})}var t=$(".element-slider").length;$(".circle-header p").html(t),$(".circle-rew p").html(t),$(".center-header ul li:eq(0)").on("click",function(){$("body, html").stop().animate({scrollTop:$(".wrapp-about h1").offset().top-100+"px"},400)}),$(".center-header ul li:eq(1)").on("click",function(){$("body, html").stop().animate({scrollTop:$(".service h1").offset().top-100+"px"},400)}),$(".center-header ul li:eq(2)").on("click",function(){$("body, html").stop().animate({scrollTop:$(".wrapp-work h1").offset().top-100+"px"},400)}),$(".reviews-header .bg-nav-rev").on("click",function(){$("body, html").stop().animate({scrollTop:$(".container-title-rew h1").offset().top-100+"px"},400)}),$(".center-header ul li:eq(4)").on("click",function(){$("body, html").stop().animate({scrollTop:$(".wrapp-reward h1").offset().top-100+"px"},400)}),$(".center-header ul li:eq(5)").on("click",function(){$("body, html").stop().animate({scrollTop:$(".wrapp-map h1").offset().top-100+"px"},400)}),$(".reviews-header").hover(function(){$(this).css({background:"#fff"}),$(this).children("p").css({color:"#000"}),$(".review-add").css("display","block")},function(){$(this).css({background:""}),$(this).children("p").css({color:"#d9d9d9"}),$(".review-add").css("display","none")});var n,c=0;$(".service-preview").on("click",function(){c=$(this).index(".service-preview")+1}),$(".upper-service .service-preview").on("click",function(){$(".b-wrapp-hide-service").stop().slideUp(200,function(){o=null,$(".b-wrapp-hide-service .elem-hide img").css("display","none"),$(".b-wrapp-hide-service .entry-content").css("display","none")});var e=$(this).index(".upper-service .service-preview");if(null!=n){if(n===e)return $(".wrapp-hide-service").stop().slideUp(200,function(){$(".wrapp-hide-service .elem-hide img").css("display","none"),$(".wrapp-hide-service .entry-content").css("display","none")}),n=null,!1;$(".wrapp-hide-service .entry-content:eq("+n+")").css("display","none"),$(".wrapp-hide-service .elem-hide img:eq("+n+")").css("display","none")}$(".wrapp-hide-service .entry-content:eq("+e+")").css("display","block"),$(".wrapp-hide-service .elem-hide img:eq("+e+")").css("display","block"),$(".wrapp-hide-service").stop().slideDown(200),n=e});var o;$(".bottom-service .service-preview").on("click",function(){$(".wrapp-hide-service").stop().slideUp(200,function(){n=null,$(".wrapp-hide-service .elem-hide img").css("display","none"),$(".wrapp-hide-service .entry-content").css("display","none")});var e=$(this).index(".bottom-service .service-preview");if(null!=o){if(o===e)return $(".b-wrapp-hide-service").stop().slideUp(200,function(){$(".b-wrapp-hide-service .elem-hide img").css("display","none"),$(".b-wrapp-hide-service .entry-content").css("display","none")}),o=null,!1;$(".b-wrapp-hide-service .entry-content:eq("+o+")").css("display","none"),$(".b-wrapp-hide-service .elem-hide img:eq("+o+")").css("display","none")}$(".b-wrapp-hide-service .entry-content:eq("+e+")").css("display","block"),$(".b-wrapp-hide-service .elem-hide img:eq("+e+")").css("display","block"),$(".b-wrapp-hide-service").stop().slideDown(200),o=e});var a=0,i=setInterval(function(){$(".loading").css("background-position","0px "+a+"px"),a+=40,a>480&&(a=0)},50),s=function(){i=setInterval(function(){$(".loading").css("background-position","0px "+a+"px"),a+=40,a>480&&(a=0)},200)},l=$(".galerey").data("sum"),p=1;$(".frame").on("click",function(){blockScroll(),$(".wrapp-galerey").fadeIn(200),$(".galerey").css("display","none"),$(".loading").fadeIn(200),s();var e=$(this).index(".frame");p=e+1,$(".image-g").attr("src","img/galerey/"+p+".jpg");var r=$(".image-g");if("frame active"!=$(".frame:eq("+e+")").attr("class"))r.load(function(){$(".galerey").fadeIn(200),$(".frame:eq("+e+")").addClass("active");var r=$(".galerey");r.css("dislplay","block");var t=r.width()+20,n=r.height()+20;r.css("margin-top",-n/2+"px"),r.css("margin-left",-t/2+"px"),$(".loading").fadeOut(200),clearInterval(i)});else{$(".galerey").fadeIn(200),$(".frame:eq("+e+")").addClass("active");var t=$(".galerey");t.css("dislplay","block");var n=t.width()+20,c=t.height()+20;t.css("margin-top",-c/2+"px"),t.css("margin-left",-n/2+"px"),$(".loading").fadeOut(200),clearInterval(i)}}),$(".arrow-right-g").on("click",function(){s(),$(".loading").fadeIn(200),p+1>l?p=1:p++,$(".galerey").fadeOut(200,function(){$(".image-g").attr("src","img/galerey/"+p+".jpg");var e=$(".image-g");e.load(function(){$(".galerey").fadeIn(200);var e=$(".galerey"),r=e.width()+20,t=e.height()+20;e.css("margin-top",-t/2+"px"),e.css("margin-left",-r/2+"px"),$(".loading").fadeOut(200),clearInterval(i)})})}),$(".arrow-left-g").on("click",function(){s(),$(".loading").fadeIn(200),1>p-1?p=l:p--,$(".galerey").fadeOut(200,function(){$(".image-g").attr("src","img/galerey/"+p+".jpg");var e=$(".image-g");e.load(function(){$(".galerey").fadeIn(200);var e=$(".galerey"),r=e.width()+20,t=e.height()+20;e.css("margin-top",-t/2+"px"),e.css("margin-left",-r/2+"px"),$(".loading").fadeOut(200),clearInterval(i)})})}),$(".galerey .close, .wrapp-galerey .galerey-bg").on("click",function(){$(".wrapp-galerey").fadeOut(200),unblockScroll(),clearInterval(i)});var d,u=new Date,m=u.getFullYear();d=m%4==0&&m%100!=0||m%400==0?29:28;var f,h=$(".month-action");switch(u.getMonth()){case 0:f="January 31",h.text("Января");break;case 1:f="February "+d,h.text("Февраля");break;case 2:f="March 31",h.text("Марта");break;case 3:f="April 30",h.text("Апреля");break;case 4:f="May 31",h.text("Мая");break;case 5:f="June 30",h.text("Июня");break;case 6:f="July 31",h.text("Июля");break;case 7:f="August 31",h.text("Августа");break;case 8:f="September 30",h.text("Сентября");break;case 9:f="October 31",h.text("Октября");break;case 10:f="November 30",h.text("Ноября");break;case 11:f="December 31",h.text("Декабря")}e(),$(".contentnav a:first").addClass("active");var v=$(".content-holder").width()+50,g=$(".element-slider").size()+20,w=v*g;$(".content-slider").css({width:w}),rotate=function(){var e=$active.attr("rel")-1,r=e*v;$(".contentnav a").removeClass("active"),$active.addClass("active"),$(".content-slider").stop().animate({left:-r},750)},rotation=function(){play=setInterval(function(){$active=$(".contentnav a.active").next(),0===$active.length&&($active=$(".contentnav a:first")),rotate()},2e4)},rotation(),$(".contentnav a").click(function(){return $active=$(this),clearInterval(play),rotate(),rotation(),!1}),$(".forwardSlide").on("click",function(){return clearInterval(play),$active=$(".contentnav a.active").next(),0===$active.length&&($active=$(".contentnav a:first")),rotate(),rotation(),!1}),$(".backSlide").on("click",function(){return clearInterval(play),$active=$(".contentnav a.active").prev(),"1"===$(".contentnav a.active").attr("rel")&&($active=$(".contentnav a").last()),rotate(),rotation(),!1}),$(".scrollbar-inner").scrollbar(),$(".scrollbar-outer").scrollbar();var b=1001,k=$(".element-slider-rew").length,y=0;rotate_rew=function(){k>y+1?(y++,$(".content-slider-rew").stop().animate({left:-b*y},750)):($(".content-slider-rew").stop().animate({left:0},750),y=0)},rotate_left_rew=function(){0>y-1?($(".content-slider-rew").stop().animate({left:-b*(k-1)},750),y=k-1):(y--,$(".content-slider-rew").stop().animate({left:-b*y},750))},rotation_rew=function(){play_rew=setInterval(function(){rotate_rew()},5e3)},rotation_rew(),$(".forwardSlide-rew").on("click",function(){return clearInterval(play_rew),rotate_rew(),rotation_rew(),!1}),$(".backSlide-rew").on("click",function(){return clearInterval(play_rew),rotate_left_rew(),rotation_rew(),!1});var x=0;$(".header-comment").on("click",function(){$(".wrapp-lead-inf").stop().fadeToggle(300),x=x?0:1}),$(document).click(function(e){if(x){if($(e.target).closest(".header-comment, .wrapp-lead-inf").length)return;$(".wrapp-lead-inf").stop().fadeToggle(300),x=0}}),$(".header-obr-form, #elem_7").hover(function(){var e=$("#elem_7").children("p");e.css("color","#fff")},function(){var e=$("#elem_7").children("p");e.css("color","#d9d9d9")}),$(".header-obr-form, #elem_7, .button-form, .footer-button-obr, .block, .telephone-header").on("click",function(){$(".modal-wrapp").fadeIn(300),blockScroll(),P=1}),servPosition=0,$(".service-obr").on("click",function(){$(".modal-wrapp").fadeIn(300),servPosition=1,blockScroll(),P=1}),$(".close-form, .cancel, .modal-background").on("click",function(){$(".modal-wrapp").fadeOut(300),unblockScroll(),P=0}),$(".review-add").on("click",function(){$(".modal-wrapp-rev").fadeIn(300),blockScroll(),P=1}),$(".modal-background-rev, .cancel-rev, .close-form-rev").on("click",function(){$(".modal-wrapp-rev").fadeOut(300),unblockScroll(),P=0}),blockScroll=function(){document.onmousewheel=document.onwheel=function(){return!1},document.addEventListener("MozMousePixelScroll",function(){return!1},!1),document.onkeydown=function(e){return e.keyCode>=33&&e.keyCode<=40?!1:void 0}},unblockScroll=function(){document.onmousewheel=document.onwheel=function(){return!0},document.addEventListener("MozMousePixelScroll",function(){return!1},!0),document.onkeydown=function(e){return e.keyCode>=33&&e.keyCode<=40?!0:void 0}};var I=1;$(".buttonShow").on("click",function(){1==I?($(".wrappQuestions").stop().animate({right:"0px"},200),$(".arrowQuestion").css("background-position","0px 0px"),I=!I):($(".wrappQuestions").stop().animate({right:"-294px"},200),$(".arrowQuestion").css("background-position","13px 0px"),I=!I)});var S,q,O;$(".headerPunctQuestion").on("click",function(){var e=$(this).index(".headerPunctQuestion");q=e;var r=$(this).children("img").attr("src");"img/header/arrow-right-w.png"===r?$(this).children("img").attr("src","img/header/arrow-down.png"):$(this).children("img").attr("src","img/header/arrow-right-w.png"),null!=S&&(S.css("background",""),S.children("p").css("color","#37a332"),O!=q&&S.children("img").attr("src","img/header/arrow-right.png")),O=q,S=$(this).css("background","#37a332"),S.children("p").css("color","#fff"),$(".inform:eq("+e+")").stop().slideToggle(100).siblings(".inform:visible").slideUp(100)}),$(".headerPunctQuestion").hover(function(){var e=$(this).children("img").attr("src");"img/header/arrow-down.png"!=e&&$(this).children("img").attr("src","img/header/arrow-right-w.png")},function(){var e=($(this).children("img").attr("src"),$(this).index(".headerPunctQuestion"));e!=q&&$(this).children("img").attr("src","img/header/arrow-right.png")}),upBtn=$(".up"),$(window).scroll(function(){$(this).scrollTop()>500?(upBtn.fadeIn(200),0===_&&(_=1,upBtn.children("img").attr("src","img/arrow-up.png"))):1===_&&upBtn.fadeOut(200)});var T,_=1;upBtn.on("click",function(){_?(T=$(window).scrollTop(),$(window).scrollTop(0),upBtn.children("img").attr("src","img/arrow-down.png"),_=0):($(window).scrollTop(T),upBtn.children("img").attr("src","img/arrow-up.png"),_=1)}),$(".phone, #phone5").keypress(function(e){return 8!=e.which&&0!=e.which&&(e.which<48||e.which>57)?!1:void 0}),$("input[type='submit']").click(function(e){e.preventDefault()});var P=0,Q=0;success=function(e,r){switch(blockScroll(),$(".wrapp-modal-success").fadeIn(200),e){case 0:$(".title-form-suc").text("Заявка отправлена."),$(".icon-form-suc").attr("src","img/modal/check.png"),$(".text-form-suc").html(""!=r?r+". Ваша заявка отправлена.":"Ваша заявка отправлена."),$(".success").css("display","block"),$(".error").css("display","none"),$(".close-form-suc").css("display","block"),$(".close-form-err").css("display","none");break;case 1:$(".title-form-suc").text("Вопрос отправлен."),$(".icon-form-suc").attr("src","img/modal/check.png"),$(".text-form-suc").html("В ближайшее время с Вами<br>свяжутся наши специалисты!"),$(".success").css("display","block"),$(".error").css("display","none"),$(".close-form-suc").css("display","block"),$(".close-form-err").css("display","none");break;case 2:$(".title-form-suc").text("Телефон оптравлен"),$(".icon-form-suc").attr("src","img/modal/check.png"),$(".text-form-suc").html("В ближайшее время с Вами<br>свяжутся наши специалисты!"),$(".success").css("display","block"),$(".error").css("display","none"),$(".close-form-suc").css("display","block"),$(".close-form-err").css("display","none");break;case 3:$(".title-form-suc").text("Отзыв отправлен."),$(".icon-form-suc").attr("src","img/modal/check.png"),$(".text-form-suc").html(r+". Ваш отзыв отправлен."),$(".success").css("display","block"),$(".error").css("display","none"),$(".close-form-suc").css("display","block"),$(".close-form-err").css("display","none")}},error=function(e){switch(blockScroll(),$(".wrapp-modal-success").fadeIn(200),e){case 0:$(".title-form-suc").text("Заполните поле “ваш телефон”"),$(".icon-form-suc").attr("src","img/modal/alert.png"),$(".text-form-suc").html("Поле телефон обязательно для заполнения."),$(".success").css("display","none"),$(".error").css("display","block"),$(".close-form-suc").css("display","none"),$(".close-form-err").css("display","block");break;case 1:$(".title-form-suc").text("Не менее шести цифр"),$(".icon-form-suc").attr("src","img/modal/alert.png"),$(".text-form-suc").html("Поле ввода телефона должно содержать<br>не менее 6-ти цифр"),$(".success").css("display","none"),$(".error").css("display","block"),$(".close-form-suc").css("display","none"),$(".close-form-err").css("display","block");break;case 2:$(".title-form-suc").text("Заполните все поля"),$(".icon-form-suc").attr("src","img/modal/alert.png"),$(".text-form-suc").html("В данной форме все поля обязательны<br>для заполнения."),$(".success").css("display","none"),$(".error").css("display","block"),$(".close-form-suc").css("display","none"),$(".close-form-err").css("display","block")}},$(".success, .close-form-suc").on("click",function(){$(".wrapp-modal-success").fadeOut(200),P=0,unblockScroll()}),$(".error, .close-form-err").on("click",function(){$(".wrapp-modal-success").fadeOut(200),0===P&&unblockScroll(),1===Q?$(".modal-wrapp").fadeIn(200):2===Q&&$(".modal-wrapp-rev").fadeIn(200)}),$(".button").click(function(){var e=$(this).index(".button"),r=$(".name:eq("+e+")").val(),t=$(".phone:eq("+e+")").val(),n=$(".button:eq("+e+")").val(),o=$(".phone:eq("+e+")").val().length,a=e;""==t?(error(0),3===e?($(".modal-wrapp").fadeOut(200),Q=1):Q=0):6>o?(error(1),3===e?($(".modal-wrapp").fadeOut(200),Q=1):Q=0):(3===e&&$(".modal-wrapp").fadeOut(200),0!=servPosition&&(a+=c),servPosition=0,$.ajax({url:"../mailScript/mail.php",type:"POST",data:{name:r,phone:t,button:n,form:a},success:function(t){t[0]?(success(0,r),$(".form:eq("+e+")").trigger("reset")):alert("Не отправлено")}}))}),$(".button-rev").click(function(){var e=$(".name-rev").val(),r=$("#form-text-rev").val(),t=$(this).val();""==e||""==r?(error(2),$(".modal-wrapp-rev").fadeOut(200),Q=2):($(".modal-wrapp-rev").fadeOut(200),$.ajax({url:"../mailScript/mailReview.php",type:"POST",data:{name:e,text:r,button:t},success:function(r){r[0]?(success(3,e),$(".form-review").trigger("reset")):alert("Не отправлено")}}))}),$("#btnQuestion").click(function(){var e=$("#mail").val(),r=$("#question").val(),t=$("#btnQuestion").val();form="Задать вопрос, отправив на email",""==e||""==r?(error(2),Q=0):$.ajax({url:"../mailScript/mailq1.php",type:"POST",data:{email:e,question:r,button:t,form:form},success:function(e){e[0]?(success(1),$("#formQuestion").trigger("reset")):alert("Не отправлено")}})}),$("#btnPhone").click(function(){var e=$("#phone5").val(),r=e.length,t=$("#btnPhone").val(),n="Отправить свой номер телефона";""==e?(error(0),Q=0):6>r?(error(1),Q=0):$.ajax({url:"../mailScript/mailq2.php",type:"POST",data:{phone:e,button:t,form:n},success:function(e){e[0]?(success(2),$("#formPhone").trigger("reset")):alert("Не отправлено")}})}),$(".element-service img").hover(function(){var e=$(this).index(".element-service img");$(".content-service:eq("+e+")").css("background","#ebebeb")},function(){var e=$(this).index(".element-service img");$(".content-service:eq("+e+")").css("background","")})});
